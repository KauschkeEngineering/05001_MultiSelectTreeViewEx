...
namespace System.Windows.Controls
{
    public class VirtualizingTreePanel : VirtualizingPanel, IScrollInfo
    {
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            MultiSelectTreeViewExItem treeViewItem = itemsControl as MultiSelectTreeViewExItem;
            MultiSelectTreeViewEx treeView = itemsControl as MultiSelectTreeViewEx ?? treeViewItem.ParentTreeView;
                ...
                try
                {
                    ...
                    for (int i = 0; i < itemCount; i++)
                    {
                        ...
                        if (isVisibleItem)
                        {
                            ...
                            bool newlyRealized;
                            MultiSelectTreeViewExItem child = generator.GenerateNext(out newlyRealized) as MultiSelectTreeViewExItem;
        ...
        private static void InvalidateMeasure(MultiSelectTreeViewExItem child)
        {
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            if (treeView.IsVirtualizing)
            {
                ...
                {
                    MultiSelectTreeViewExItem child = itemsControl.ItemContainerGenerator.ContainerFromIndex(i) as MultiSelectTreeViewExItem;
                    int childHierarchyLevel = 0;
        ...
        private void AddOrInsertItemToInternalChildren(int itemGeneratorIndex, MultiSelectTreeViewExItem child)
        {
        ...
        private double GetCachedOrEstimatedHeight(MultiSelectTreeViewEx tree, int level)
        {
        ...
        private void RegisterHeight(MultiSelectTreeViewEx tree, int level, double size)
        {
        ...
        private void Debug(MultiSelectTreeViewExItem item, string message)
        {
            if (item != null)
            {
        ...
        {
            MultiSelectTreeViewExItem treeViewItem = ItemsControl.GetItemsOwner(this) as MultiSelectTreeViewExItem;
        ...
        public Rect MakeVisible(Visual visual, Rect rectangle)
        {
            ...
            MultiSelectTreeViewExItem treeViewExItem = visual as MultiSelectTreeViewExItem;
