...
namespace System.Windows.Controls
{
    ...
    {
        AdornerLayer layer;
        internal MultiSelectTreeViewExItem treeViewItem;
        ContentPresenter contentPresenter;

        public InsertAdorner(MultiSelectTreeViewExItem treeViewItem, InsertContent content)
        ...
        public static Border GetParentBorder(MultiSelectTreeViewExItem item)
        {
