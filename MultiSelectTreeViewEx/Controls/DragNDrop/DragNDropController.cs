...
namespace System.Windows.Controls
{
    ...
    class DragNDropController : InputSubscriberBase, IDisposable
    {
        ...
        private CanInsertReturn CanInsert(MultiSelectTreeViewExItem item, Func<UIElement, Point> getPositionDelegate, IDataObject data)
        {
            ...
            else
            {
                ...
                MultiSelectTreeViewExItem parentItem = item.ParentTreeViewItem;
        ...
        private bool CanDrop(MultiSelectTreeViewExItem item, IDataObject data)
        {
        ...
        MultiSelectTreeViewExItem itemMouseIsOver;
        ...
        private List<MultiSelectTreeViewExItem> GetDraggableItems(Point mousePositionRelativeToTree)
        {
            MultiSelectTreeViewExItem itemUnderMouse = GetTreeViewItemUnderMouse(mousePositionRelativeToTree);
            if(itemUnderMouse == null) return new List<MultiSelectTreeViewExItem>();
            
            List<MultiSelectTreeViewExItem> items = TreeView.GetTreeViewItemsFor(TreeView.SelectedItems).ToList();
            ...
            if (!items.Contains(itemUnderMouse))
            {
                ...
                items = new List<MultiSelectTreeViewExItem>();
